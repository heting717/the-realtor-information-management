										...
										<TABLE cellSpacing=0 cellPadding=2 border=0>
											<TBODY>
												<TR>
													<TD>房屋面积：</TD>
													<TD>
														<INPUT class=textbox id=sChannel2 style="WIDTH: 80px" maxLength=50 name="cust_area" " value="${model.cust_area}">
													</TD>
													<TD>地理位置：</TD>
													<TD>
														<INPUT class=textbox id=sChannel2 style="WIDTH: 80px" maxLength=50 name="cust_address" value="${model.cust_address}">
													</TD>
													<TD>价格范围：</TD>
													<TD>
														<INPUT class=textbox id=sChannel2 style="WIDTH: 80px" maxLength=50 name="cust_low_price" value="${model.cust_low_price}">
													</TD>
													
													<TD>
														<INPUT class=textbox id=sChannel2 style="WIDTH: 80px" maxLength=50 name="cust_high_price" value="${model.cust_high_price}">
													</TD>
												</TR>
												<TR>
													<TD>客户名称：</TD>
													<TD>
														<INPUT class=textbox id=sChannel2 style="WIDTH: 80px" maxLength=50 name="cust_name" >
													</TD>
										...
										<TABLE id=grid
											...
											<TBODY>
												...
												<TR
													...
													<TD>${customer.cust_area }</TD>
													<TD>${customer.cust_address }</TD>
													<TD>${customer.cust_low_price }-${customer.cust_high_price }</TD>
													<TD>
