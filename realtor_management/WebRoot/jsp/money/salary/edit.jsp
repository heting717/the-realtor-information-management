					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							...
							<TR>
								...
								<td>
								<INPUT class=textbox id=sChannel2
														style="WIDTH: 180px" maxLength=50 name="cust_area" value="${model.cust_area }">
								</td>
								<td>地理位置 ：</td>
								<td>
								<INPUT class=textbox id=sChannel2
							...
							<TR>
								...
								<td>
								<INPUT class=textbox id=sChannel2
														style="WIDTH: 180px" maxLength=50 name="cust_low_price" value="${model.cust_low_price }">
								</td>
								<td>~</td>
								<td>
								<INPUT class=textbox id=sChannel2
														style="WIDTH: 180px" maxLength=50 name="cust_high_price" value="${model.cust_high_price }">
								</td>
