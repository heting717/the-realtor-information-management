							...
							<TBODY>
									...
									<TD>
										<TABLE id=table_1 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall>
														<A class=style2 href="${ pageContext.request.contextPath }/customer_initAddUI.action" target=main>－ 客户信息录入</A></TD>
												</TR>
												<TR> 
													<TD class=menuSmall>
								...
								<TR>
									<TD class=mainMenu onClick="MenuDisplay('table_2');"><SPAN
										class=span id=table_2Span>＋</SPAN> 财务管理</TD>
								</TR>
								<TR>
									<TD>
										<TABLE id=table_2 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath}/income_initAddUI.action" target=main>－ 添加收入信息</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath}/income_findByPage.action" target=main>－ 收入信息列表</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath}/expend_initAddUI.action" target=main>－ 添加支出信息</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall>
														<A class=style2 href="${pageContext.request.contextPath}/expend_findByPage.action" target=main> － 支出信息列表</A>
													</TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath}/salary_initAddUI.action" target=main>－ 发工资</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall>
														
														<A class=style2  href="${pageContext.request.contextPath}/salary_findByPage.action" target=main> - 工资信息</A>
													</TD>
												</TR>
								...
								<TR>
									<TD class=mainMenu onClick="MenuDisplay('table_5');"><SPAN
										class=span id=table_5Span>＋</SPAN> 人事管理</TD>
								</TR>
								<TR>
									<TD>
										<TABLE id=table_5 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall>
														<A class=style2 href="${ pageContext.request.contextPath }/emp_initAddUI.action" target=main> － 新增员工</A>
													</TD>
												</TR>
												<TR>
													<TD class=menuSmall>
														<A class=style2 href="${ pageContext.request.contextPath }/emp_findByPage.action" target=main> － 员工列表</A>
													</TD>
												</TR>
								...
								<TR>
									<TD class=mainMenu onClick="MenuDisplay('table_6');"><SPAN
										class=span id=table_6Span>＋</SPAN>部门管理</TD>
								</TR>
								<TR>
									<TD>
										<TABLE id=table_6 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2 href="${ pageContext.request.contextPath }/dept_initAddUI.action"
														target=main>－添加部门</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2 href="${ pageContext.request.contextPath }/dept_findByPage.action"
